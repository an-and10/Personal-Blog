               ...
               <form method="post" class="form-horizontal" enctype="multipart/form-data"><!-- form-horizontal Begin -->
                   ...
                   <div class="form-group"><!-- form-group Begin -->
                       ...
                       <div class="col-md-6"><!-- col-md-6 Begin -->
                           ...
                           <input name="author" type="text" class="form-control" required value="<?php echo $author ?>">
                   ...
                   <div class="form-group"><!-- form-group Begin -->
                      ...
                      <div class="col-md-6"><!-- col-md-6 Begin -->
                          ...
                          <input name="product_img1" type="file" class="form-control" required value="<?php echo $author_images ?>" >
                              <img class="img-responsive" src="product_images/<?php echo $images; ?>" alt="Post Image">
                   ...
                   <div class="form-group"><!-- form-group Begin -->
                      ...
                      <div class="col-md-6"><!-- col-md-6 Begin -->
                          ...
                          <input name="product_img2" type="file" class="form-control  form-control form-height-custom" value="<?php echo $images ?>">
                          <img class="img-responsive" src="product_images/<?php echo $images; ?>" alt="Post Image">
                   ...
                   <div class="form-group"><!-- form-group Begin -->
                      ...
                      <div class="col-md-6"><!-- col-md-6 Begin -->
                        ...
                        <textarea name="data" cols="19" rows="6" class="form-control">
