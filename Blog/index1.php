...
-->
  <div class=" container middle">
    <div class="container header">
      <p class="lead description"> Wherever you want to go, first prepare yourself for the journey!<span class="small">This is the big journey</span></p>
    </div>
  ...
  <div class="col-md-12  col-sm-12 main">
    ...
    <div class="col-sm-8  col-md-8 border">
      <div class="col-sm-7 col-md-7">
        <div class="post">
          <h3 class="title">Post 1</h3>
          <p class="postmeta"> Date<span class="small"> Published by Anand</span></p>
          <h4 class="caption"></h4>
          <p class="desc">
...
<br>
  <div class="col-sm-5  col-md-5 first-image">
...
<br>
  <div class="col-sm-4 col-md-4">
    ...
    <div class="col-sm-8  col-md-8 border">
      <div class="col-sm-7 col-md-7">
        <div class="post">
          <h3 class="title">Post No. 2</h3>
          <p class="postmeta"> Date<span class="small"> Published by Anand</span></p>
          <h4 class="caption"> What so Special</h4>
          <p class="desc">
            Requires JavaScript plugin
If JavaScript is disabled and the viewport is narrow enough that the navbar collapses, it will be impossible to expand the navbar and view the content within the .navbar-collapse.
...
<br>
 <div class="col-sm-4 col-md-4">
    <div class="sidebar-content inset">
      ...
      <div class="col-md-7">
        <p class="small-text">Join us today with us. Be a part of our team. </p>
    </div>
      </div>
              <div class="sidebar-content latest">
                <h4> Latest Topics Covered</h4>
                <ul>
                 <li class="glyphicon glyphicon-star"> Hacking v/s Ethical Hacking</li>
                  <li class="glyphicon glyphicon-star" >Upcoming Google Project</li>
                  <li class="glyphicon glyphicon-star">What is V.R?</li>
                  <li class="glyphicon glyphicon-star">Facts on Statue of Unity</li>
...
<br>
  <div class="col-sm-4 col-md-4">
    <div class="sidebar-content inset1">
      <h4>Thinking! Thinking! Be a top writer this Weakend.</h4>
      <div class="col-md-5  sidebar-image">
        <img src="images/2.jpg" alt="about me" class="image-responsive">
      </div>
      <div class="col-md-7">
        <p class="small-text member"> Interested in writing a blog. Have something creative and want to show . Here, a great opportunity to be with us. Write a blog or the favourite Article. </p>
    </div>
      </div>
